...
\title{Modelación y simulación de cultivos con el modelo WOFOST. Desarrollo de una interfaz de usuario.}
\author{\\\vspace{0.25cm}Eduardo Moreira González}
\advisor{\\\vspace{0.25cm}Jorge Díaz Suárez}
\coadvisor{\\\vspace{0.25cm}Edel García Reyes}
\degree{Licenciado en Ciencia de la Computación}
\faculty{Facultad de Matemática y Computación}
\date{Diciembre, 2022\\\vspace{0.25cm}\href{https://github.com/eduar297/thesis}{github.com/eduar297/thesis}}
